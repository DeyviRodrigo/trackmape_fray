                          ...
                          child: InkWell(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  equipo.activo ? "Estado: Vigente" : "Estado: Finalizado",
                                  style: TextStyle(
      ...
      children: [
        if (!equipo.activo)
          _buildBotonCompacto(
            label: "REACTIVAR",
            color: Colors.green,
            onPressed: () => _repositorio.actualizarEquipo(equipo.id, {'fecha_final': null}),
          ),
        if (equipo.activo)
          _buildBotonCompacto(
            label: "FINALIZAR",
            color: Colors.red,
            onPressed: () => _repositorio.actualizarEquipo(
              equipo.id,
