      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 30),
            SwitchListTile(
              title: const Text("Equipo vigente", style: TextStyle(color: Colors.white)),
              value: _vigente,
              activeColor: Colors.orange,
              onChanged: (val) => setState(() => _vigente = val),
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                final exito = await _repositorio.actualizarEquipo(widget.equipo.id, {
                  ...
                  'fecha_final': _vigente ? null : DateTime.now().toIso8601String().split('T').first,
                });
                if (exito && mounted) {
