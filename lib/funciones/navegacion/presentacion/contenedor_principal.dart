...
// NUEVA PAGINA CONDUCTOR
import 'package:trackmape_sup/funciones/monitoreo/presentacion/paginas/pagina_conductor.dart';
...
class _ContenedorPrincipalState extends State<ContenedorPrincipal> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (_indiceActual) {
      ...
      case 3:
        ...
        break;
      case 4:
        tituloHeader = "PANEL DEL CONDUCTOR";
        break;
      default:
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          currentIndex: (_indiceActual <= 1)
              ? _indiceActual
              : (_indiceActual == 4 ? 2 : 0),

          onTap: (indice) {
            if (indice == 2) {
              setState(() => _indiceActual = 4);
            } else {
    ...
    return Drawer(
      ...
      child: Column(
        children: [
          ...
          _itemMenu(Icons.play_circle_filled,
              "Transcurso Simulado", 3,
              color: Colors.greenAccent),

          const Divider(color: Colors.white10, indent: 20, endIndent: 20),

          _itemMenu(Icons.engineering,
              "Base de Operadores", 2),
  ...
  Widget _itemMenu(IconData icono, String titulo, int indice,
